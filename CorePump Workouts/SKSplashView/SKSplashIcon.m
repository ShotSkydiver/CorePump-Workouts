...
- (void) startAnimation
{
    if([self.delegate respondsToSelector:@selector(splashIconView:didBeginAnimatingWithDuration:)])
    {
        [self.delegate splashIconView:self didBeginAnimatingWithDuration:self.animationDuration];
    }
...
- (void) endAnimating
{
    ...
    if([self.delegate respondsToSelector:@selector(splashIconViewDidEndAnimating:)])
    {
        [self.delegate splashIconViewDidEndAnimating:self];
    }
}
